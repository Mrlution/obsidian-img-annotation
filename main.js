    ...
    this.registerEvent(this.app.workspace.on("active-leaf-change", async (leaf) => {
      ...
      if (!canvasView.isRegisteredTouchEvents) {
        ...
        this.registerDomEvent(canvasView.containerEl, "touchmove", (event) => {
          ...
          if (Math.abs(canvasView.HarmonyTableMouseEndTouches.clientX - canvasView.HarmonyTableMouseStartTouches.clientX < 1e-12)) {
